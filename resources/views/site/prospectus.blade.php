                ...
                <div class="col-sm-7">
                    <div class="exam-sec">
                        ...
                        <div class="download-btns">
                            <a href="{{(isset($banner))? URL::asset('public/uploads/bannars/'.$banner->banner_file) : 'No Data Found' }}" class="btn pdf-btn-download" download><i class="icofont-download"></i> Download Prospectus</a>
                        </div>
                    </div>
                </div>
                <div class="col-sm-5">
