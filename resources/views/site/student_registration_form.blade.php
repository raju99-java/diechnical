            ...
            <div class="col-sm-12">
                <div class="breadcrumb-title-div">
                    ...
                    <div class="breadcrumb-ul right-side">
                        <ul>
                            <li><a href="/">HOME</a>/</li>
                            <li><span>Student Registration Form</span></li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="col-sm-7">
                    <div class="exam-sec">
                        ...
                        <div class="download-btns">
                            <a href="{{(isset($banner))? URL::asset('public/uploads/bannars/'.$banner->banner_file) : 'No Data Found' }}" class="btn pdf-btn-download" download><i class="icofont-download"></i> Download Student Registration Form</a>
                        </div>
                    </div>
                </div>
                <div class="col-sm-5">
