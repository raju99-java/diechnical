            ...
            <div class="col-sm-12">
                <div class="breadcrumb-title-div">
                    ...
                    <div class="breadcrumb-ul right-side">
                        <ul>
                            <li><a href="/">HOME</a>/</li>
                            <li><span>Franchise Affiliation Form</span></li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="col-sm-7">
                    <div class="exam-sec">
                        <div class="Director-Message">
                            <h3>Franchise Affiliation Form</h3>		
                        </div>
                        <div class="download-btns">
                            <a href="{{ URL::asset('public/frontend/images/Franchise Offer.JPG') }}" class="btn pdf-btn-download" download><i class="icofont-download"></i> Download Franchise Affiliation Form</a>
                        </div>
                    </div>
                </div>
                <div class="col-sm-5">
