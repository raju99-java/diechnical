    ...
    <div class="col-md-12">
        <div class="portlet light bordered">
            ...
            <div class="portlet-body form">
                <form method="post" action="{{route('franchise_student-edit',['id'=>$id])}}" class="form-horizontal" enctype="multipart/form-data">
                    @method('PUT')
                    {{csrf_field()}}
                        ...
                        <div class="form-group {{ $errors->has('category') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-10">
                                <select name="category" class="form-control">
                                    ...
                                    <option value="General" class="option" {{ (old('gender')!="") ? ('General'==old('category'))?'selected':'' : strcasecmp("General","$user->category")?'':'selected'}}>General</option>
                                    <option value="SC" class="option" {{ (old('gender')!="") ? ('SC'==old('category'))?'selected':'' : strcasecmp("SC","$user->category")?'':'selected'}}>SC</option>
                                    <option value="ST" class="option" {{ (old('gender')!="") ? ('ST'==old('category'))?'selected':'' : strcasecmp("ST","$user->category")?'':'selected'}}>ST</option>
                                    <option value="OBC" class="option" {{ (old('gender')!="") ? ('OBC'==old('category'))?'selected':'' : strcasecmp("OBC","$user->category")?'':'selected'}}>OBC</option>
                                </select>
                    ...
                    <div class="form-actions">
                        <div class="row">
                            <div class="col-md-12 text-center">
                                <a href="{{Route('franchise-student-list')}}" class="btn btn-primary">Cancel</a>
