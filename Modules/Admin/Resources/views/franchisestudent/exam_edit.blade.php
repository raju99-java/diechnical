...
<ul class="page-breadcrumb breadcrumb">
    ...
    <li>
        <a href="{{Route('franchise-student_exam-list',['id'=>$model->user_id])}}">Exam Data List</a>
        <i class="fa fa-circle"></i>
    </li>
        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-red-sunglo bold uppercase">Exam Data of student {{$model->user->full_name}} course {{$model->course->name}}</span>
                </div>
            </div>
            <div class="portlet-body form">
                
                <form  method="post" action="{{route('franchise-student_exam-edit',['id'=>$id])}}" class="form-horizontal" enctype="multipart/form-data">
                        ...
                        <div class="form-actions">
                            <div class="row">
                                <div class="col-md-12 text-center">
                                    <a href="{{Route('franchise-student_exam-list',['id'=>$model->user_id])}}" class="btn btn-primary">Cancel</a>
