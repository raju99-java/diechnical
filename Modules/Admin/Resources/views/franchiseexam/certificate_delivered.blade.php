...
<ul class="page-breadcrumb breadcrumb">
    ...
    <li> <a href="{{Route('franchise-student-exams')}}">Franchise Exam Management</a>
        <i class="fa fa-circle"></i>
    </li>
    <li> <span class="active">Franchise Student Exam Certificate</span>
    </li>
</ul>
<div class="row">
    <div class="col-md-12">
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-red-sunglo bold uppercase">Exam Certificate of Franchise Student {{$model->user->full_name}} course {{$model->course->name}}</span>
                </div>
            </div>
            <div class="portlet-body form">
                <form method="post" action="{{route('franchise-student-certificate-delivered',['id'=>$id])}}" class="form-horizontal" enctype="multipart/form-data">
                    @method('post')
                    {{csrf_field()}}
