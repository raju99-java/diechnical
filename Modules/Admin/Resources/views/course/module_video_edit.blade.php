...
<ul class="page-breadcrumb breadcrumb">
    ...
    <li>
        <a href="{{Route("admin-course-module", [$data->course_id])}}">Course Module</a>
        <i class="fa fa-circle"></i>
    </li>
    <li>
        <a href="{{Route("admin-course-module-video", [$data->module_id])}}">Course Module Video of {{$data->module->name}}</a>
        <i class="fa fa-circle"></i>
    </li>
    <li>
    ...
    <div class="col-md-12">
        <div class="portlet light bordered">
            ...
            <div class="portlet-body form">
                <form method="post" action="{{route('admin-course-module-video-edit',$data->id)}}" class="form-horizontal" enctype="multipart/form-data">
                    {{csrf_field()}}
                    ...
                    <div class="form-actions">
                        <div class="row">
                            <div class="col-md-12 text-center">
                                <a href="{{Route("admin-course-module-video", [$data->module_id])}}" class="btn btn-primary">Cancel</a>
