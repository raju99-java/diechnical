...
<ul class="page-breadcrumb breadcrumb">
    ...
    <li>
        <a href="{{Route('requested-users')}}">Requested User</a>
        <i class="fa fa-circle"></i>
    </li>
    <li>
    ...
    <div class="col-md-12">
        <div class="portlet light bordered">
            ...
            <div class="portlet-body form">
                <form method="post" action="{{route('requested-user-edit',['id'=>$id])}}" class="form-horizontal" enctype="multipart/form-data">
                    @method('PUT')
                    {{csrf_field()}}
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-12 ">Registration Number:</label>
                            <div class="col-md-9">
                        ...
                        <div class="form-group {{ $errors->has('approve_status') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-10">
                                ...
                                <div class="radio-list">
                                    <label class="radio-inline">
                                        <input type="radio" name="approve_status" value="1"  {{ ($user->approve_status == '1') ? 'checked' : '' }} > Approve 
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" name="approve_status" value="3" {{ ($user->approve_status == '3') ? 'checked' : '' }} > Decline 
                                    </label>
                                    @if ($errors->has('approve_status'))
                                    <div class="help-block">{{ $errors->first('approve_status') }}</div>
                                    @endif
                                </div>
                      	...
                      	<div class="form-group {{ $errors->has('decline_reason') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-10">
                                <input type="text" class="form-control" placeholder="Decline Reason" name="decline_reason" value="{{ (old('decline_reason')!="") ? old('decline_reason') : ''}}"/>
                                       @if ($errors->has('decline_reason'))
                                       <span class="help-block"> {{ $errors->first('decline_reason') }} </span>
                                @endif
                            </div>
                        </div>
                        @else
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                            @if ($user->approve_status == '0') 
                                <span class="badge badge-warning"><i class="icofont-warning"></i>Submitted</span>
                            @elseif ($user->approve_status == '1') 
                                <span class="badge badge-success"><i class="icofont-check"></i>Approved</span>
                            @elseif ($user->approve_status == '3') 
                                <span class="badge badge-danger"><i class="icofont-close"></i>Decline</span>
                            @endif
                    ...
                    <div class="form-actions">
                        <div class="row">
                            <div class="col-md-12 text-center">
                                <a href="{{Route('requested-users')}}" class="btn btn-primary">Cancel</a>
                                @if($user->approve_status == '0')
