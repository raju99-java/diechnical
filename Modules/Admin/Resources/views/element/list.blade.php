...
<ul class="page-breadcrumb breadcrumb">
    ...
    <li>
        <span class="active">Element Management</span>
    </li>
</ul>
<div class="portlet light bordered">
    <div class="portlet-title">
        <div class="caption">
            ...
            <span class="caption-subject font-red-sunglo bold uppercase">Element Management</span>
        </div>
        <div class="pull-right"><a href="{{route('element-add')}}" class="btn btn-success"><i class="fa fa-plus"></i> Add New</a></div>
    </div>
...
//    });
    $(function () {
        $('#element-management').DataTable({
            serverSide: true,
            responsive: true,
            ajax: '{{ route("element-list-datatable") }}',
            columns: [
