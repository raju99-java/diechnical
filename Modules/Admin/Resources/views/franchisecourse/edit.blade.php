        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-red-sunglo bold uppercase">Update Franchise Course of {{$data->name}}</span>
                </div>
            </div>
            <div class="portlet-body form">
                <form method="post" action="{{route('franchise-course-list-update',$data->id)}}" class="form-horizontal" enctype="multipart/form-data">
                    {{csrf_field()}}
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group {{ $errors->has('no_of_reviews') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-10">
                                <input type="number" class="form-control" placeholder="No of Reviews" name="no_of_reviews" value="{{ (old('no_of_reviews')!="") ? old('no_of_reviews') : $data->no_of_reviews }}"/>
                        ...
                        <div class="form-group {{ $errors->has('students_enrolled') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-10">
                                <input type="number" class="form-control" placeholder="Students Enrolled" name="students_enrolled" value="{{ (old('students_enrolled')!="") ? old('students_enrolled') : $data->students_enrolled }}"/>
                        ...
                        <div class="form-group {{ $errors->has('course_language') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-10">
                                <input type="text" class="form-control" placeholder="Course Language" name="course_language" value="{{ (old('course_language')!="") ? old('course_language') : $data->course_language}}"/>
                        ...
                        <div class="form-group {{ $errors->has('course_level') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-10">
                                <input type="text" class="form-control" placeholder="Course Level" name="course_level" value="{{ (old('course_level')!="") ? old('course_level') : $data->course_level}}"/>
                        ...
                        <div class="form-group {{ $errors->has('what_you_will_learn') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-10">
                                <textarea class="form-control ckeditor" placeholder="What You Will Learn" name="what_you_will_learn"  id="what_you_will_learn">{{ (old('what_you_will_learn')!="") ? old('what_you_will_learn') : $data->what_you_will_learn }}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('jobs_that_require_this_skill') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-10">
                                <textarea class="form-control ckeditor" placeholder="Jobs That Require This Skill" name="jobs_that_require_this_skill"  id="jobs_that_require_this_skill">{{ (old('jobs_that_require_this_skill')!="") ? old('jobs_that_require_this_skill') : $data->jobs_that_require_this_skill }}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('requirements') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-10">
                                <textarea class="form-control ckeditor" placeholder="Requirements" name="requirements"  id="requirements">{{ (old('requirements')!="") ? old('requirements') : $data->requirements }}</textarea>
                        ...
                        <div class="form-group">
                            <div class="col-md-10">
                                <a href="{{isset($data->video)?URL::asset('public/uploads/course/'.$data->video):''}}" class="btn btn-xs btn-primary pull-left" target="_blank"><i class="fa fa-eye"></i>Demo Video</a><br/>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-10">
                        ...
                        <div class="form-group {{ $errors->has('course_type') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-10">
                                <input type="text" class="form-control" placeholder="Course Type" name="course_type" value="{{ (old('course_type')!="") ? old('course_type') : $data->course_type}}"/>
                            ...
                            <div class="col-md-10">
                                <div class="radio-list">
                                    <label class="radio-inline">
                                        <input type="radio" name="exam_status" value="1" {{ ($data->exam_status == '1') ? 'checked' : '' }}> Yes
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" name="exam_status" value="0" {{ ($data->exam_status == '0') ? 'checked' : '' }}> No
                                    </label>
                        ...
                        <div class="form-group {{ $errors->has('live') ? ' has-error' : '' }}">
                            <label class="control-label col-md-3">Live <span class="required">*</span></label>
                            <div class="col-md-10">
                                <div class="radio-list">
                                    <label class="radio-inline">
                                        <input type="radio" name="live" value="1" {{ ($data->live == '1') ? 'checked' : '' }}> Active
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" name="live" value="0" {{ ($data->live == '0') ? 'checked' : '' }}> Inactive
                                    </label>
                                    @if ($errors->has('live'))
                                    <div class="help-block">{{ $errors->first('live') }}</div>
                                    @endif
                                </div>
                            </div>
                        </div>
