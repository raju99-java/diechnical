...
<div class="portlet light bordered">
    <div class="portlet-title">
        ...
        <div class="pull-right"><a href="{{route('franchise-course-live-class',$data->id)}}" class="btn btn-success"><i class="fa fa-plus"></i> Add New</a></div>
    </div>
    <div class="portlet-body ">
        <div class="clearfix">
            <div class="table-responsive">
                <table class="ui celled table" cellspacing="0" width="100%" id="live-class-management">
                    <thead>
                        <tr>
                            <th>#</th>
                            <th>Subject</th>
...
//    });
$(function () {
    $('#live-class-management').DataTable({
        serverSide: true,
        responsive: true,
        ajax: '{{ route("franchise-course-live-class-data",$data->id) }}',
        columns: [
