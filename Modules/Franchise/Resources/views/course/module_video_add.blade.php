...
<ul class="page-breadcrumb breadcrumb">
    ...
    <li>
        <a href="{{Route("franchise-course-module-video", [$coursemodule->id])}}">Course Module Video of {{$coursemodule->name}}</a>
        <i class="fa fa-circle"></i>
    </li>
    <li>
    ...
    <div class="col-md-12">
        <div class="portlet light bordered">
            ...
            <div class="portlet-body form">
                <form method="post" action="{{route('franchise-course-module-video-add',$coursemodule->id)}}" class="form-horizontal" enctype="multipart/form-data">
                    {{csrf_field()}}
                    ...
                    <div class="form-actions">
                        <div class="row">
                            <div class="offset-md-3 col-md-9">
                                <a href="{{Route("franchise-course-module-video", [$coursemodule->id])}}" class="btn btn-primary">Cancel</a>
