...
<ul class="page-breadcrumb breadcrumb">
    ...
    <li>
        <a href="{{Route('franchise-course-live-class-list',$data->id)}}">Live Class Management</a>
        <i class="fa fa-circle"></i>
    </li>
    <li>
    ...
    <div class="col-md-12">
        <div class="portlet light bordered">
            ...
            <div class="portlet-body form">
                <form method="post" action="{{route('franchise-course-live-class',$data->id)}}" class="form-horizontal" enctype="multipart/form-data">
                    {{csrf_field()}}
