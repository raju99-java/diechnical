...
<ul class="page-breadcrumb breadcrumb">
    ...
    <li>
        <a href="{{Route("franchise-course-module", [$data->course_id])}}">Course Module of {{$data->course->name}}</a>
        <i class="fa fa-circle"></i>
    </li>
    <li>
        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-red-sunglo bold uppercase">Update Course for {{$data->course->name}} of module {{$data->name}}</span>
                </div>
            </div>
            <div class="portlet-body form">
                <form method="post" action="{{route('franchise-course-module-edit',$data->id)}}" class="form-horizontal" enctype="multipart/form-data">
                    {{csrf_field()}}
                    ...
                    <div class="form-actions">
                        <div class="row">
                            <div class="col-md-12 text-center">
                                <a href="{{Route("franchise-course-module", [$data->course_id])}}" class="btn btn-primary">Cancel</a>
