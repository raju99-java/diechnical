...
<ul class="page-breadcrumb breadcrumb">
    ...
    <li>
        <a href="{{Route('franchise-centers')}}">Center List Management</a>
        <i class="fa fa-circle"></i>
    </li>
    <li>
        <span class="active">Add Center</span>
    </li>
</ul>
<div class="row">
    <div class="col-md-12">
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-red-sunglo bold uppercase">Add Center</span>
                </div>
            </div>
            <div class="portlet-body form">
                <form id="center-add-form" method="post" action="{{route('franchise-center-add')}}" class="form-horizontal" enctype='multipart/form-data'>
                    
                    @csrf
                    
                        <div class="col-xs-12 text-center">
							<h2 class="application">APPLICATION FORM FOR AFFILIATION</h2>
						</div>
						...
						<tr>
    						<td colspan="4"><h3>Information About Institution
    						<span style="color: red;font-weight: normal;">(All fields are mandatory!)</span></h3>
    						</td>
						</tr>
						...
						<tr>
    						...
    						<tr>
        						<td>Payment through Wallet</td>
        						<td class="box_left2 form-group {{ $errors->has('wallet') ? ' has-error' : '' }}" colspan="3">
                    ...
                    <div class="form-actions">
                        <div class="row">
                            <div class="col-md-5 offset-md-4">
                                <a href="{{Route('franchise-center-add')}}" class="btn btn-primary">Cancel</a>
