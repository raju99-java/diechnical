...
<ul class="page-breadcrumb breadcrumb">
    ...
    <li>
        <span class="active">Franchise Certificate</span>
    </li>
</ul>
<div class="portlet light bordered">
    <div class="portlet-title">
        <div class="caption">
            ...
            <span class="caption-subject font-red-sunglo bold uppercase">Franchise Certificate</span>
        </div>
...
$(function () {
    $('#exam-management').DataTable({
        serverSide: true,
        responsive: true,
        ajax: '{{ route("franchise-certificate-datatables") }}',
        columns: [
