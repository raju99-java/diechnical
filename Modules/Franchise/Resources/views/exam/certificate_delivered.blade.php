...
<ul class="page-breadcrumb breadcrumb">
    ...
    <li> <a href="{{Route('franchise-student-exam-answer-index')}}">Exam Management</a>
        <i class="fa fa-circle"></i>
    </li>
    ...
    <div class="col-md-12">
        <div class="portlet light bordered">
            ...
            <div class="portlet-body form">
                <form method="post" action="{{route('franch-student-certificate-delivered',['id'=>$id])}}" class="form-horizontal" enctype="multipart/form-data">
                    @method('post')
                    {{csrf_field()}}
