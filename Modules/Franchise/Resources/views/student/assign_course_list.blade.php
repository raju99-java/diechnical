    ...
    <div class="portlet-body ">
        <div class="clearfix">
            <div class="table-responsive">
                <table class="ui celled table" cellspacing="0" width="100%" id="course-asign-list">
                    <thead>
                        <tr>
                            <th>#</th>
                            <th>Course Name</th>
...
//    });
$(function () {
    $('#course-asign-list').DataTable({
        serverSide: true,
        responsive: true,
        ajax: '{{ route("franchise-student-assign-course-list-datatables",$id) }}',
        columns: [
