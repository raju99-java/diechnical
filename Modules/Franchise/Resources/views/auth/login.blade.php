...
<div class="content">
    <!-- BEGIN LOGIN FORM -->
    <form class="login-form" action="{{ url('/franchise/franchise-login') }}" method="post">
        {{ csrf_field() }}
        ...
        <div class="form-footer">
            <a href="{{route('franchise-forgot-password')}}">Forgot Your Password?</a>
            <p>Don't have account? <a href="/apply-online" target="_blank">Create New Account</a></p>
      </div>
