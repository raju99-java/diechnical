...
class VerifyCsrfToken extends Middleware
{
    ...
    protected $except = ['*cancel-signup*','*success-signup*','*dopayment*','*cancel-payment*','*pay-supply-fee*','*cancel-supply-payment*','*success-student-add*','*cancel-student-add*',
                          ...
                          '*success-apply-online*','*cancel-apply-online*','*success-center-add*','*cancel-center-add*','*success-renew-plan*','*cancel-renew-plan*','*success-recharge-wallet*',
                          '*cancel-recharge-wallet*'];
}
